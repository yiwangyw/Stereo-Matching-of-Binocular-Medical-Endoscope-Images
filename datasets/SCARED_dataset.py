...
class ScaredDatset(Dataset):
    def __init__(self, datapath, list_filename, training):
        ...
        self.left_filenames, self.right_filenames, self.left_disp_filenames = self.load_path(list_filename) 
        # print(self.left_filenames, self.right_filenames, self.left_disp_filenames)#, self.left_disp_filenames, self.right_disp_filenames
        self.training = training

    def load_path(self, list_filename):
        lines = read_all_lines(list_filename)
        splits = [line.split() for line in lines] # 将字符串切片
...
# Mean EPE: 2.735, Mean D1: 14.441, Mean D3: 13.087 original

# Mean EPE: 2.299, Mean D1: 12.840, Mean D3: 11.456 refiner new 

# Mean EPE: 2.599, Mean D1: 13.741, Mean D3: 12.269 feature

# Mean EPE: 2.573, Mean D1: 14.312, Mean D3: 12.657 refiner new + feature 