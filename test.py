...
def parse_args():
    ...
    parser.add_argument('--datapath', type=str, default='/home/yw_stereomatch/dataset/SCARED/')
    parser.add_argument('--batch_size', type=int, default=10)
    parser.add_argument('--ckpt', type=str, default='./log/PASMnet_SCARED_epoch10.pth.tar')
...
def main(cfg):
    ...
    if cfg.dataset == 'SCARED':
        test_set = ScaredDatset(datapath=cfg.datapath, list_filename= 'filenames/scared_test.txt', training=False)
